function validateAddManufacturer() {
    ...
    // Validate License Expiry (optional but must be future date if provided)
    ...
    if (licenseExpiry !== '') {
        ...
        if (expiryDate < today) {
            showError('licenseExpiryError', 'License expiry date cannot be in the past');
            isValid = false;
        }
    }
