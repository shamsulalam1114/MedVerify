...
// Get all manufacturers with statistics (for admin management)
...
// Check if license number exists excluding a specific manufacturer
...
// Get medicine count for a manufacturer
